...
//         Table { name: "users" }
//     }
//     pub const age: Col<i32> = Col::new("age", Table { name: "users" });
//     pub const has_children: Col<bool> = Col::new("has_children", Table { name: "users" });
//     pub const username: Col<String> = Col::new("username", Table { name: "users" });
// }
//
// #[test]
// fn test_col_define() {
...
//         temp: "fuck".to_string(),
//     };
//     assert_eq!(User::id, Col::<i32>::new("id", setup::table_users()));
//     assert_eq!(User::name, Col::<String>::new("username", setup::table_users()));
//     assert_eq!(User::age, Col::<u32>::new("age", setup::table_users()));
//     assert_eq!(User::nick_name, Col::<String>::new("nick_name", setup::table_users()));
//     assert_eq!(User::checked, Col::<bool>::new("checked", setup::table_users()));
//     assert_eq!(User::gender, Col::<String>::new("gender", setup::table_users()));
//     assert_eq!(user.id, 1);
// }
//
